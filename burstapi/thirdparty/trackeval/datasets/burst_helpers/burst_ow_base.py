...
from burstapi.thirdparty.trackeval.utils import TrackEvalException
from burstapi.thirdparty.trackeval.datasets._base_dataset import _BaseDataset
from burstapi.thirdparty.trackeval import utils
from burstapi.thirdparty.trackeval import _timing
...
class BURST_OW_Base(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': None,  # os.path.join(code_path, 'data/gt/tao/tao_training'),  # Location of GT data
            'TRACKERS_FOLDER': None,  # os.path.join(code_path, 'data/trackers/tao/tao_training'),  # Trackers location
    ...
    def __init__(self, pred_path, gt_path, config=None):
        ...
        self.tracker_data['vids_to_tracks'] = curr_videos_to_tracker_tracks
        self.tracker_data['vids_to_images'] = curr_videos_to_tracker_images
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if is_gt:
            ...
            imgs = self.tracker_data['vids_to_images'][seq_id]
        ...
        if is_gt:
            ...
            all_tracks = self.tracker_data['vids_to_tracks'][seq_id]
